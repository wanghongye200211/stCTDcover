...
window.stCTD_FIGURES = {
  figure1: {
    ...
    legend:
      "Fig. 1: stCTD graphical abstract and model overview. a. Discrete spatial transcriptomic snapshots are connected as a continuous single-cell tissue trajectory; observed slices and generated snapshots are separated in the schematic, and the dynamic paths highlight a candidate critical transition point. b. Training framework for stCTD: spatial coordinates, graph-prior gene embeddings and time labels feed the spatiotemporal potential-transport equation, which learns spatial velocity, gene-latent potential, growth or decay, and an optimization objective combining matching, spatial, physical and dynamic losses. c. Downstream analyses and applications, including generated spatial slices, lineage inference, critical-point warning, and perturbed gene-program interpretation.",
  ...
  figure6: {
    ...
    body:
      "The model comparison summarizes how stCTD differs from other methods in prediction, alignment, temporal interpolation, and biological interpretability across datasets.",
    legend:
